  ...
  <el-container class="login-wrap" :class="[bgImg]">
    ...
    <el-footer height="auto">
      <el-row>
        ...
        <el-col :span="6">
          <img src="static/img/subions.jpg" width="88">
        </el-col>
        <el-col :span="6">
          <img src="static/img/mini-program.jpg" width="88">
        </el-col>
      </el-row>
      <div class="app-login-record"><a href="http://iotgateway.net/" target="_blank"> Doc</a> © 2022 iotgateway all rights reserved</div>
    </el-footer>
  </el-container>
</template>
<script lang="ts">
...
export default class App extends Vue {
    links: any[] = [
        { text: "Github", url: "https://github.com/iioter/iotgateway" },
        { text: "Gitee", url: "https://gitee.com/iioter/iotgateway" },
        { text: "Vue", url: "https://cn.vuejs.org/" },
        { text: "WTM", url: "https://github.com/dotnetcore/WTM" },
        { text: "WTM-Doc", url: "https://wtmdoc.walkingtec.cn/" },
