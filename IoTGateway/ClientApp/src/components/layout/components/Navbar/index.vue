        ...
        <div class="right-menu">
            ...
            <el-dropdown class="avatar-container right-menu-item hover-effect">
                ...
                <el-dropdown-menu slot="dropdown">
                    ...
                    <a v-if="isDev" target="_blank" href="https://github.com/iioter/iotgateway">
                        <el-dropdown-item>
                            {{ $t('navbar.github') }}(github)
                        </el-dropdown-item>
                    </a>
                    <a v-if="isDev" target="_blank" href="https://gitee.com/iioter/iotgateway">
                        <el-dropdown-item>
                            {{ $t('navbar.github') }}(gitee)
                        </el-dropdown-item>
                    </a>
